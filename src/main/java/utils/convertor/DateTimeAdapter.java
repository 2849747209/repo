...
public class DateTimeAdapter implements Adapter {
	...
	public void setTarget(Object target) {
		if (null != target) {
			if (Date.class.isInstance(target)) {
				...
				throw new ClassCastException(target + " is not instance of java.util.Date");
			}
		}
	}
	...
	public boolean toboolean() throws ClassCastException {
		throw new ClassCastException("java.util.Date cannot be cast to boolean");
	}

	@Override
	public Boolean toBoolean() throws ClassCastException {
		throw new ClassCastException("java.util.Date cannot be cast to java.lang.Boolean");
	}
	...
	public char tochar() throws ClassCastException {
		throw new ClassCastException("java.util.Date cannot be cast to char");
	}

	@Override
	public Character toCharacter() throws ClassCastException {
		throw new ClassCastException("java.util.Date cannot be cast to java.lang.Character");
	}
	...
	public String toString() throws ClassCastException {
		Date target = targetHolder.get();
		if (null != target) {
			return Formatter.toDateTime(target);
		} else {
			return "";
		}
	}

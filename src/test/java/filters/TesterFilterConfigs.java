...
public class TesterFilterConfigs {
    ...
    public static FilterConfig getDefaultFilterConfig() {
        final String allowedHttpHeaders =
                org.apache.catalina.filters.CorsFilter.DEFAULT_ALLOWED_HTTP_HEADERS;
        final String allowedHttpMethods =
                org.apache.catalina.filters.CorsFilter.DEFAULT_ALLOWED_HTTP_METHODS;
        final String allowedOrigins = org.apache.catalina.filters.CorsFilter.DEFAULT_ALLOWED_ORIGINS;
        final String exposedHeaders = org.apache.catalina.filters.CorsFilter.DEFAULT_EXPOSED_HEADERS;
        final String supportCredentials =
                org.apache.catalina.filters.CorsFilter.DEFAULT_SUPPORTS_CREDENTIALS;
        final String preflightMaxAge =
                org.apache.catalina.filters.CorsFilter.DEFAULT_PREFLIGHT_MAXAGE;
        final String decorateRequest = org.apache.catalina.filters.CorsFilter.DEFAULT_DECORATE_REQUEST;
    ...
    public static FilterConfig getFilterConfigAnyOriginAndSupportsCredentials() {
        final String allowedHttpHeaders =
                org.apache.catalina.filters.CorsFilter.DEFAULT_ALLOWED_HTTP_HEADERS;
        final String allowedHttpMethods =
                org.apache.catalina.filters.CorsFilter.DEFAULT_ALLOWED_HTTP_METHODS + ",PUT";
        final String allowedOrigins = org.apache.catalina.filters.CorsFilter.DEFAULT_ALLOWED_ORIGINS;
        final String exposedHeaders = org.apache.catalina.filters.CorsFilter.DEFAULT_EXPOSED_HEADERS;
    ...
    private static FilterConfig generateFilterConfig(final String allowedHttpHeaders,
                                                     final String allowedHttpMethods,
                                                     final String allowedOrigins,
                                                     final String exposedHeaders,
                                                     final String supportCredentials,
        ...
        FilterConfig filterConfig = new FilterConfig() {
            ...
            public String getInitParameter(String name) {
                if (org.apache.catalina.filters.CorsFilter.PARAM_CORS_ALLOWED_HEADERS
                        .equalsIgnoreCase(name)) {
                    return allowedHttpHeaders;
                } else if (org.apache.catalina.filters.CorsFilter.PARAM_CORS_ALLOWED_METHODS
                        .equalsIgnoreCase(name)) {
                    return allowedHttpMethods;
                } else if (org.apache.catalina.filters.CorsFilter.PARAM_CORS_ALLOWED_ORIGINS
                        .equalsIgnoreCase(name)) {
                    return allowedOrigins;
                } else if (org.apache.catalina.filters.CorsFilter.PARAM_CORS_EXPOSED_HEADERS
                        .equalsIgnoreCase(name)) {
                    return exposedHeaders;
                } else if (org.apache.catalina.filters.CorsFilter.PARAM_CORS_SUPPORT_CREDENTIALS
                        .equalsIgnoreCase(name)) {
                    return supportCredentials;
                } else if (org.apache.catalina.filters.CorsFilter.PARAM_CORS_PREFLIGHT_MAXAGE
                        .equalsIgnoreCase(name)) {
                    return preflightMaxAge;
                } else if (org.apache.catalina.filters.CorsFilter.PARAM_CORS_REQUEST_DECORATE
                        .equalsIgnoreCase(name)) {
